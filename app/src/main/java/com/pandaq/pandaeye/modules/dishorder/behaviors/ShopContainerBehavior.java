package com.pandaq.pandaeye.modules.dishorder.behaviors;
...
public class ShopContainerBehavior extends CoordinatorLayout.Behavior<ShopInfoContainer> {
	...
	private void shouldInitProperties() {
		...
		int statusBarHeight = com.pandaq.pandaeye.modules.dishorder.utils.ViewUtils.getStatusBarHeight(mContext);
		int acBarHeight = com.pandaq.pandaeye.modules.dishorder.utils.ViewUtils.dip2px(mContext, 56);
