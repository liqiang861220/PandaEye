...
import static com.pandaq.pandaeye.modules.dishorder.CreateOrderActivity.CLEARCAR_ACTION;
...
public class DetailActivity extends BaseActivity implements AddWidget.OnAddClick {
	...
	private void initShopCar() {
		...
		flist.addAll(CreateOrderActivity.carAdapter.getData());
	...
	private void dealCar(FoodBean foodBean) {
		...
		Intent intent = new Intent(CreateOrderActivity.CAR_ACTION);
	...
	private class SpaceItemDecoration extends RecyclerView.ItemDecoration {
		...
		SpaceItemDecoration() {
			this.space = ViewUtils.dip2px(DetailActivity.this, 2);
		}
